    ...
    return {
        ...
        */
        get: function (callback) {
            $.ajax({
                type: "POST",
                url: basePath + '/systemSettingController/getWallpaper.do',
                dataType: "json",
                success: function (data) {
                    var i = data.result;
                    var t = i.split("<{|}>");
                    HROS.CONFIG.wallpaperState = parseInt(t[0]);
                    switch (HROS.CONFIG.wallpaperState) {
                        case 1:
                        case 2:
                            HROS.CONFIG.wallpaper = t[1];
                            HROS.CONFIG.wallpaperType = t[2];
                            HROS.CONFIG.wallpaperWidth = parseInt(t[3]);
                            HROS.CONFIG.wallpaperHeight = parseInt(t[4]);
                            break;
                        case 3:
                            HROS.CONFIG.wallpaper = t[1];
                            break

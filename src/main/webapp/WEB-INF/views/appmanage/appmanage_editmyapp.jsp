...
<html>
        ...
        <script>
            $(function () {
                ...
                uploader.on('beforeFileQueued', function (file) {
                    if (file.size / 1024 > 300.499999999999999) {
                        $.dialog({
    ...
    <body>
        <form action="${pageContext.request.contextPath}/appManageController/editMyApp.do" method="post" name="form"
              id="form">
            ...
            <div class="creatbox">
                <div class="middle">
                        ...
                        <div class="label-box form-inline control-group">
                            <div class="input-prepend input-append">
                                <span class="add-on">宽</span><input type="text" name="val_width"
                                                                    value="${memberAppModel.width}" style="width:40px"
                                                                    datatype="n" nullmsg="请输入应用宽高"
                            ...
                            <div class="input-prepend input-append" style="margin-left:10px">
                                <span class="add-on">高</span><input type="text" name="val_height"
                                                                    value="${memberAppModel.height}" style="width:40px"
                                                                    datatype="n" nullmsg="请输入应用宽高"
                                                                    errormsg="宽高数值不规范"><span class="add-on">px</span>
                            </div>
                            <span class="help-inline"></span>
                    ...
                    <div class="input-label input-label-isresize"  ${memberAppModel.type=='widget'?'style="display:none"':''} >
                    ...
                    <div class="input-label input-label-isopenmax" ${memberAppModel.type=='widget'?'style="display:none"':memberAppModel.isresize=='0'?'style="display:none"':''} >
                    ...
                    <%-- 	<div class="input-label input-label-isflash" ${memberAppModel.type=='widget'?'style="display:none"':''}>

                ...
                $('body').on('click', '.app-menu a[menu="edit"]', function () {
                    ...
                    if (HROS.base.checkLogin()) {
                        dialog({
                            ...
                            url: 'appManageController/toEditMyAppPage.do?id=' + data.obj.attr('appid'),
                            padding: 0,
                            width: 770,
                            height: 450
                        }).showModal();
                    ...
                    if (HROS.base.checkLogin()) {
                        swal({
                            ...
                            $.ajax({
                                ...
                                url: basePath + "/desktopSettingController/updateFolder.do",
                            }).done(function (responseText) {
                                HROS.app.get();
                                swal({
                                    type: 'success',
                    ...
                    swal({
                        ...
                        HROS.app.remove(data.obj.attr('appid'), function () {
                            ...
                            data.obj.find('img, span').show().animate({
                                ...
                                //ww修改(删除缩略图)
                                var delete_id = "#qv_" + data.obj.attr('appid')
                                $(delete_id).remove();
                                data.obj.remove();
                                HROS.deskTop.resize();
                            });
